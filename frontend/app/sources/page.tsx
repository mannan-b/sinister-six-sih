      ...
      <div className="p-5 rounded-lg bg-black border border-zinc-800 space-y-4">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs">
            <thead className="bg-zinc-900 border-b border-zinc-800 text-[10px] text-zinc-400 uppercase tracking-wider">
              <tr>
            ...
            <tbody className="divide-y divide-zinc-800/50">
              {runs.map((r) => (
                <tr key={r.id} className="hover:bg-zinc-900/50 transition-colors">
                  <td className="px-4 py-3 text-[10px] text-zinc-400">{r.id.slice(0, 8)}...</td>
                  ...
                  <td className="px-4 py-3 text-white font-bold">+{r.entities_extracted}</td>
                  <td className="px-4 py-3 text-zinc-300 font-bold">+{r.relationships_extracted}</td>
